  ...
  const handleExport = () => {
    ...
    try {
      if (tab === "overview") {
        ...
        esportaCSVPanoramica(params);
      } else {
        esportaCSVReport(atletiMese, reportMese, reportAnno, filtroCat, filtroTipoInf !== "Tutti" ? filtroTipoInf : "", mesiPeriodo, periodoLabel);
      }
    } finally {
      setEsportando(null);
    }
      ...
      <div className="mb-6 flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="flex gap-2">
            <button onClick={handleExport} disabled={!!esportando}
